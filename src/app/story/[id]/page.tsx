      ...
      <div className="min-h-screen bg-black">
        ...
        <div className="relative">
          ...
          <div className="relative h-[250px] md:h-[400px] w-full overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black md:hidden"></div>
            
            {/* Content Container */}
            <div className="relative h-full flex items-center justify-center z-20">
              <div className="text-center px-4 md:px-0">
                <h1 className="text-4xl md:text-7xl font-bold text-white mb-2 md:mb-0">
                  {story.world_name}
                </h1>
              </div>
            </div>
          ...
          {/* Main Content */}
          <div className="relative z-30 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 md:-mt-32">
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-800">
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        This will delete all your conversations and progress.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-6">
                    ...
                    {selectedChapter && (
                      <div className="mb-8 p-6 rounded-xl bg-gray-800/30 border border-gray-700/50">
                        <h3 className="text-xl font-semibold text-white mb-4">Chapter Preview</h3>
                        ...
                        <button
                          ...
                          className={`
                            w-full mt-6 py-3 px-6 rounded-xl font-medium transition-all duration-300
